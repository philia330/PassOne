  ...
  interface BaaDialogProps {
    ...
    onTeknisiAdded?: () => void;
    // ============================================================
    // MODE TERKONTROL (dipakai dari BaaTable/dropdown aksi untuk mode "edit") --
    // kalau "open" dikasih, tombol trigger sendiri (pensil) TIDAK dirender lagi,
    // buka/tutup sepenuhnya dikendalikan dari luar. Tombol "Tambah BAA" (mode
    // "create") di halaman utama TETAP jalan seperti biasa karena tidak
    // mengirim prop ini (uncontrolled, pakai state internal).
    // ============================================================
    open?: boolean;
