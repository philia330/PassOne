...
export default function BaaDetailError({
  error,
  reset,
}: {
    ...
    <div className="min-h-screen bg-slate-50 font-sans antialiased flex items-center justify-center p-6">
      <div className="w-full max-w-md rounded-3xl shadow-xl border bg-white p-8 text-center space-y-4">
        ...
        <div className="space-y-1">
          <h2 className="text-lg font-bold text-slate-900">Gagal Memuat Detail BAA</h2>
          <p className="text-sm text-slate-500">
            Terjadi kesalahan saat mengambil detail BAA. Coba lagi, atau pastikan data yang
            Anda akses masih tersedia.
          </p>
        </div>
