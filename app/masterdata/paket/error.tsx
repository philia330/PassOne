...
export default function PaketError({
  error,
  reset,
}: {
  ...
  // Catat error ke console supaya gampang dicek pas development/debugging.
  useEffect(() => {
    console.error(error);
  }, [error]);
    ...
    <div className="min-h-screen bg-slate-50 font-sans antialiased flex items-center justify-center p-6">
      <div className="w-full max-w-md rounded-3xl shadow-xl border bg-white p-8 text-center space-y-4">
        ...
        <div className="space-y-1">
          <h2 className="text-lg font-bold text-slate-900">Gagal Memuat Data Paket</h2>
