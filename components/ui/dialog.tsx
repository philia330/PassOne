        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-2 right-2 cursor-pointer rounded-xl active:scale-90 transition-transform hover:bg-slate-100 dark:hover:bg-slate-800"
                size="icon-sm"
              />
            }
          >
            <XIcon className="text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200" />
