...
// Warna badge dibatasi ke palet utama PASSNET (purple/fuchsia/sky/slate),
// sesuai aturan "jangan pakai hijau/merah/orange sebagai warna utama".
...
// Baris info sederhana: ikon + label + value, dipakai berkali-kali di bawah.
function InfoRow({
  icon: Icon,
  label,
  value,
...
export const BaaViewDialog = ({ baa }: BaaViewDialogProps) => {
  return (
    <Dialog>
      ...
      <DialogContent className="rounded-3xl sm:max-w-[640px] max-h-[85vh] overflow-y-auto p-1.5 -m-1.5">
        <DialogHeader>
        ...
        <div className="space-y-1 divide-y divide-slate-100">
          ...
          <div className="grid grid-cols-2 gap-x-4">
            ...
            <InfoRow
              icon={UserCog}
              label="Teknisi"
              value={baa.user ? baa.user.nama : `ID Teknisi #${baa.id_user}`}
            />
          </div>
