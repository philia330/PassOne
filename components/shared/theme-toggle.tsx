        ...
        <>
          ...
          <div className="absolute right-0 top-14 z-50 w-40 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900">
            <button
              ...
              className={`flex w-full items-center gap-2 px-4 py-3 text-sm hover:bg-slate-100 dark:hover:bg-slate-800 ${theme === "light" ? "bg-slate-100 dark:bg-slate-800" : ""}`}
            >
            ...
            <button
              ...
              className={`flex w-full items-center gap-2 px-4 py-3 text-sm hover:bg-slate-100 dark:hover:bg-slate-800 ${theme === "dark" ? "bg-slate-100 dark:bg-slate-800" : ""}`}
            >
            ...
            <button
              ...
              className={`flex w-full items-center gap-2 px-4 py-3 text-sm hover:bg-slate-100 dark:hover:bg-slate-800 ${theme === "system" ? "bg-slate-100 dark:bg-slate-800" : ""}`}
            >
